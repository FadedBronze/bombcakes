use bevy::prelude::*;
use crate::background::BackgroundFollows;
...
fn camera_follow(
  ...
  mut followed_by_camera_query: Query<&mut Transform, (With<FollowedByCamera>, Without<GameCamera>)>
) {
...
impl Plugin for GameCameraPlugin {
  fn build(&self, app: &mut App) {
    app
    .add_startup_system(create_camera).add_system(camera_follow);
  }
}